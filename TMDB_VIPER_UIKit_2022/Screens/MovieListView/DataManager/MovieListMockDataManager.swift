...
class MovieListMockDataManager: MovieListMockDataManagerInputProtocol {
    ...
    private func getMockedMovies() -> [Movie] {
        ...
        let movie2 = Movie(movieID: 414906, title: "The Batman", synopsis: "In his second year of fighting crime, Batman uncovers corruption in Gotham City that connects to his own family while facing a serial killer known as the Riddler.", image: "/33wnBK5NxvuKQv0Cxo3wMv0eR7F.jpg")
        ...
        let movie5 = Movie(movieID: 476669, title: "The King's Man", synopsis: "As a collection of history's worst tyrants and criminal masterminds gather to plot a war to wipe out millions, one man must race against time to stop them.", image: "/5cnLoWq9o5tuLe1Zq4BTX4LwZ2B.jpg")
